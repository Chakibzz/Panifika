    ...
    <section id="cta" className="relative overflow-hidden bg-[#2a0f0b] px-[22px] py-[82px] md:px-[48px] md:py-[122px]">
      ...
      <Reveal className="relative z-10 mx-auto max-w-[1040px] text-center">
        ...
        <h2 className="text-[40px] font-black uppercase leading-[0.98] tracking-[-0.04em] text-[#fff4d3] md:text-[78px]">
          Join the international bakery salon.
        </h2>
        <p className="mx-auto mt-[24px] max-w-[640px] text-[17px] leading-[1.76] text-[#f1d6a1] md:text-[19px]">
          A cinematic exhibition experience for bakers, pastry makers, equipment manufacturers and international food
          professionals.
        </p>
        <a
          href="mailto:contact@panifika-expo.com"
          className="mt-[38px] inline-flex rounded-[999px] bg-[#f3ad16] px-[34px] py-[18px] text-[12px] font-black uppercase tracking-[0.18em] text-[#4b0f0b] shadow-[0_0_50px_rgba(243,173,22,0.34)]"
        >
          Request Access
        </a>
      </Reveal>

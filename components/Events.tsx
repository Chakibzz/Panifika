...
const items = [
  ...
  "International pastry showcases",
  "Bakery technology and ingredients",
  "Chef-led live production sessions"
];
      ...
      <div className="relative mx-auto grid max-w-[1280px] gap-[46px] lg:grid-cols-[0.82fr_1.18fr] lg:gap-[72px]">
        <Reveal>
          <div className="lg:pt-[26px]">
            <p className="text-[12px] font-black uppercase tracking-[0.28em] text-[#f3ad16]">Events</p>
            <h2 className="mt-[16px] text-[38px] font-black uppercase leading-[1] tracking-[-0.035em] text-[#fff4d3] md:text-[66px]">
              Live salon moments in golden light.
            </h2>
            <div className="mt-[34px] space-y-[14px]">
              {items.map((item) => (
                <div key={item} className="gold-line-frame rounded-[18px] bg-[#24130c]/74 px-[19px] py-[17px] text-[15px] font-bold uppercase tracking-[0.08em] text-[#f3d99f]">
                  {item}
                </div>
              ))}
            </div>
        ...
        <Reveal delay={0.1}>
          <div className="relative overflow-hidden rounded-[34px] border border-[#f3ad16]/25 bg-[#080604] p-[10px] expo-glow">
            <div className="light-sweep relative aspect-[1.62] overflow-hidden rounded-[25px]">
              <Image src="/assets/expo-hall.png" alt="PANIFIKA EXPO salon floor" fill className="object-cover" sizes="(min-width: 1024px) 58vw, 100vw" />
